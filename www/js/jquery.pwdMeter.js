...
jQuery.fn.pwdMeter = function(options){
	...
	return this.each(function(index){
		...
		function evaluateMeter(){
			...
			$('.short span').addClass('neutral');
		
			switch(passwordStrength){
			case 1:
			  $('.short span').addClass('veryweak');
			  //$('#pwdMeter').text('Velmi slabé heslo');
			  break;
			case 2:
			  $('.short span').addClass('weak');
			  //$('#pwdMeter').text('Slabé heslo');
			  break;
			case 3:
			  $('.short span').addClass('medium');
			  //$('#pwdMeter').text('Dobré heslo');
			  break;
			case 4:
			  $('.short span').addClass('strong');
			 // $('#pwdMeter').text('Silné heslo');
			  break;
			case 5:
			  $('.short span').addClass('verystrong');
			  //$('#pwdMeter').text('Velmi silné heslo');
			  break;		  		  		  
			default:
			  $('.short span').addClass('neutral');
			 // $('#pwdMeter').text('');
