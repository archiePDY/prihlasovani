<?php //netteCache[01]000385a:2:{s:4:"time";s:21:"0.56181000 1373446501";s:9:"callbacks";a:2:{i:0;a:3:{i:0;a:2:{i:0;s:19:"Nette\Caching\Cache";i:1;s:9:"checkFile";}i:1;s:63:"/Users/janikm/dev/webroot/testPages/app/templates/@layout.latte";i:2;i:1373446500;}i:1;a:3:{i:0;a:2:{i:0;s:19:"Nette\Caching\Cache";i:1;s:10:"checkConst";}i:1;s:25:"Nette\Framework::REVISION";i:2;s:30:"b7f6732 released on 2013-01-01";}}}?><?php

// source file: /Users/janikm/dev/webroot/testPages/app/templates/@layout.latte

?><?php
// prolog Nette\Latte\Macros\CoreMacros
list($_l, $_g) = Nette\Latte\Macros\CoreMacros::initRuntime($template, 'tdstw5qwkw')
;
// prolog Nette\Latte\Macros\UIMacros
//
// block title
//
if (!function_exists($_l->blocks['title'][] = '_lbd13d99e3a8_title')) { function _lbd13d99e3a8_title($_l, $_args) { extract($_args)
...
// block head
//
if (!function_exists($_l->blocks['head'][] = '_lb96da0d0c13_head')) { function _lb96da0d0c13_head($_l, $_args) { extract($_args)
;
}}
...
// block scripts
//
if (!function_exists($_l->blocks['scripts'][] = '_lb9fe3f03e86_scripts')) { function _lb9fe3f03e86_scripts($_l, $_args) { extract($_args)
?>        <script>
        jQuery.ajaxSetup({
                cache: false,
                dataType: 'json',
...
">Mapa</a></li>
            <li><a <?php try { $_presenter->link("Homepage:session"); } catch (Nette\Application\UI\InvalidLinkException $e) {}; if ($_presenter->getLastCreatedRequestFlag("current")): ?>
 class="active"<?php endif  ?> href="<?php echo htmlSpecialChars($_control->link("Homepage:session")) ?>
">Session</a></li>
