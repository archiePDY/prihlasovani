...
// block _
//
if (!function_exists($_l->blocks['_'][] = '_lbff13a1732a__')) { function _lbff13a1732a__($_l, $_args) { extract($_args); $_control->validateControl(false)
