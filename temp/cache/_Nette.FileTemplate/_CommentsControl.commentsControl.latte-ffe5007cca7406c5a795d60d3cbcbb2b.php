<?php //netteCache[01]000410a:2:{s:4:"time";s:21:"0.58403500 1366973781";s:9:"callbacks";a:2:{i:0;a:3:{i:0;a:2:{i:0;s:19:"Nette\Caching\Cache";i:1;s:9:"checkFile";}i:1;s:88:"/users/janikm/dev/webroot/testPages/app/components/CommentsControl/commentsControl.latte";i:2;i:1366967884;}i:1;a:3:{i:0;a:2:{i:0;s:19:"Nette\Caching\Cache";i:1;s:10:"checkConst";}i:1;s:25:"Nette\Framework::REVISION";i:2;s:30:"b7f6732 released on 2013-01-01";}}}?><?php

// source file: /users/janikm/dev/webroot/testPages/app/components/CommentsControl/commentsControl.latte

?><?php
// prolog Nette\Latte\Macros\CoreMacros
list($_l, $_g) = Nette\Latte\Macros\CoreMacros::initRuntime($template, 'q0n635uzt9')
;
// prolog Nette\Latte\Macros\UIMacros
//
// block content
//
if (!function_exists($_l->blocks['content'][] = '_lb898620082a_content')) { function _lb898620082a_content($_l, $_args) { extract($_args)
 ?>
...
// block _comments
//
if (!function_exists($_l->blocks['_comments'][] = '_lb61d6077a8e__comments')) { function _lb61d6077a8e__comments($_l, $_args) { extract($_args); $_control->validateControl('comments')
...
// block _foo
//
if (!function_exists($_l->blocks['_foo'][] = '_lb629914804b__foo')) { function _lb629914804b__foo($_l, $_args) { extract($_args); $_control->validateControl('foo')
...
// block _form
//
if (!function_exists($_l->blocks['_form'][] = '_lba0ab6cdd22__form')) { function _lba0ab6cdd22__form($_l, $_args) { extract($_args); $_control->validateControl('form')
